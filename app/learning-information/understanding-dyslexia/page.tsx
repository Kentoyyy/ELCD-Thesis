...
const UnderstandingDyslexia = () => {
  return (
    <div className="bg-white min-h-screen flex flex-col md:flex-row px-4 py-8 sm:px-6 lg:px-8">
      {/* Sidebar */}
      <div className="hidden md:block md:w-1/5 pr-8 sticky top-8">
      ...
      <div className="w-full md:w-4/5">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Understanding Dyslexia</h1>
        ...
        {/* Quick Read Section */}
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-3">Quick Read</h2>
